...
function PostIllustration({ type, image, alt, featured = false }) {
  return (
    <div
      className={`blog-illustration blog-illustration--${type} ${featured ? "is-featured" : ""}`}
    >
      {image ? (
        <img
...
export default function Blog({
  ...
  onOpenUiUxArticle,
  onOpenSocialMediaArticle,
  onOpenSeoArticle,
  onOpenMobileFirstArticle,
  onOpenEcommerceArticle,
}) {
          ...
          <div className="container">
            <div className="blog-hero__grid">
              <div className="blog-hero__content">
                ...
                <h1>
                  Ideas, insights & <span>digital solutions.</span>
                </h1>

                <p>
                  Tips, trends and practical ideas to help you build, grow and
                      ...
                      <button
                        ...
                        onClick={
                          ...
                          "5 Website Mistakes That Make Your Business Look Unprofessional"
                            ? onOpenArticle
                            : post.title ===
                                "UI/UX Design: Why Good Design Is More Than Just Pretty"
                              ? onOpenUiUxArticle
                              : post.title ===
                                  "How Social Media Can Actually Grow Your Business"
                                ? onOpenSocialMediaArticle
                                : post.title ===
                                    "SEO Basics Every Small Business Should Know"
                                  ? onOpenSeoArticle
                                  : post.title ===
                                      "Mobile-First Design: Why Your Website Must Work on Every Screen"
                                    ? onOpenMobileFirstArticle
                                    : post.title ===
                                        "E-Commerce Website: What Your Store Needs to Convert"
                                      ? onOpenEcommerceArticle
                                      : undefined
                        }
                      >
            ...
            <div className="newsletter-card">
              ...
              <div className="newsletter-actions">
                ...
                <p
                  ...
                  role={
                    newsletterMessage?.type === "error" ? "alert" : "status"
                  }
                  aria-live="polite"
                >
        ...
        <section className="blog-bottom-cta">
          <div className="container">
            <div className="blog-bottom-cta__card">
              ...
              <button className="blog-cta-button" onClick={onOpenContact}>
                Start a Project
                <ArrowRight size={17} />
              </button>
            </div>
